                ...
                <div className='card-body d-flex align-items-center py-8'>
                    ...
                    <div className='ms-6'>
                        <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
                            ...
                            project layout specifications and preview it in real-time.
                        </p>
                        <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
                            Also, you can configurate the Layout in the code (
                            <code>src/_metronic/layout/core/_LayoutConfig.ts</code> file). Don't
                            forget clear your local storage when you are changing _LayoutConfig.
                        </p>
                    </div>
                </div>
            </div>
                  ...
                  '
                                            >
                                                <input
                                                    ...
                                                    checked={
                                                        config.app?.sidebar?.default?.minimize
                                                            ?.desktop?.enabled
                                                    }
                                                    onChange={() => {
                                                        const con = {...config}
                                            ...
                                            <input
                                                ...
                                                onChange={() => {
                                                    ...
                                                    if (
                                                        ...
                                                        con.app.header.default.content =
                                                            'page-title'
                                                        setConfig({...con})
                                                    }
                                                }}
                                ...
                                >
                                    ...
                                    <label
                                        className={clsx(
                                            ...
                                            {
                                                active:
                                                    config.app?.toolbar?.layout === 'accounting',
                                            }
                                        )}
                                    >
                                        <div className='form-check-wrapper'>
